// Brook Azene
// Example from book that lists three kids and their school supply needs, as well as cost to buy the supplies 
...
int main() {
    ...
    printf("\n%c%c needs %d pencils, %d notebooks, and 1 lunchbox\n", firstInitial, middleInitial, number_of_pencils, 
            number_of_notebooks);
